...
const FAQS = [
  {
    ...
    a: "You can join by visiting us in person or choosing a membership plan on our website. Simply select a plan, book a seat, and complete the registration.",
  },
  {
    q: "What membership plans are available?",
    a: "We offer Monthly (₹450), 6-Month (₹2499), and Annual (₹4999) plans designed for different study needs.",
  },
  {
    q: "Can I reserve a seat?",
    a: "Yes, you can reserve your preferred seat through our student dashboard or by contacting us directly.",
  },
  {
    q: "How does QR attendance work?",
    a: "Every student gets a unique ID. You simply scan the QR code at the entry and exit points to log your study hours automatically.",
  },
  {
    q: "What are the library timings?",
    a: "We are open Monday-Saturday (6:00 AM – 11:00 PM) and Sunday (7:00 AM – 9:00 PM).",
  },
];
...
export const Contact = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero Banner */}
      <section className="pt-24 pb-20 bg-[#FAF9F6]">
        <div className="container mx-auto px-6 lg:px-8 max-w-[1200px] text-center">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            Whether you have questions about memberships, seat availability,
            study shifts, or library timings, our team is always ready to assist
            you.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+919876543210"
              className="px-8 py-4 bg-[#2563EB] text-white rounded-full font-bold shadow-lg hover:bg-blue-700 transition-all flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="px-8 py-4 bg-emerald-600 text-white rounded-full font-bold shadow-lg hover:bg-emerald-700 transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-[1200px]">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {CONTACT_CARDS.map((card, i) => (
              <div
                key={i}
                className="p-8 rounded-3xl bg-white border border-slate-100 shadow-xl hover:-translate-y-2 transition-all duration-300"
              >
                <div
                  className={cn(
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2563EB]"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#c2a265]"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#c2a265] resize-none"
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-[#2563EB] text-white font-black rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-600/25 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <div className="space-y-12">
                ...
                <div className="h-[400px] w-full rounded-[2.5rem] bg-slate-800 border-4 border-white/5 overflow-hidden flex items-center justify-center relative group">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-6 py-2 bg-white text-slate-900 rounded-full font-bold hover:bg-[#c2a265] hover:text-white transition-all flex items-center gap-2 mx-auto w-fit"
                    >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="p-8 bg-white/5 border border-white/10 rounded-3xl">
                  ...
                  <p className="text-sm">
                    Available via WhatsApp and Phone for instant seat bookings.
                  </p>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-8 max-w-[800px]">
          <h3 className="text-3xl font-bold text-[#1E293B] text-center mb-12">
          ...
          <div className="space-y-4">
            {FAQS.map((faq, i) => (
              ...
              >
                ...
                {openFaq === i && (
                  <div className="px-6 py-5 text-slate-600 bg-white border-t border-slate-100 leading-relaxed">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <section className="py-12 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-6 lg:px-8 flex flex-wrap justify-center gap-8 text-slate-500 font-bold text-sm uppercase tracking-widest">
          ...
          <a href="tel:+919876543210" className="flex items-center gap-2 hover:text-[#2563EB] transition-colors">
            📞 Call
          </a>
          <a
            href="https://wa.me/919876543210"
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-8 max-w-[1000px] text-center">
          ...
          <p className="text-slate-600 text-lg mb-10">
            Join hundreds of students who trust our library for focused study.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <button
              onClick={() => scrollToSection("membership-plans")}
              className="px-10 py-4 bg-[#2563EB] text-white font-bold rounded-full shadow-lg hover:bg-blue-700 transition-all"
            >
              Book Your Seat
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="px-10 py-4 border border-slate-200 text-slate-700 font-bold rounded-full hover:border-[#c2a265] hover:text-[#c2a265] transition-all"
            >
              Contact Library
            </button>
          </div>
